...
public class ProductionTooltipPanel : MonoBehaviour, IHoverPanel
{
    [Header("UI Refs")]
    ...
    [Header("Placement")]
    [SerializeField] private Vector2 hoverOffset = new Vector2(18f, -18f);
    ...
    public void FollowMouse(Vector2 screenPos)
    {
        ...
        if (_canvas != null && _canvas.renderMode != RenderMode.WorldSpace)
        {
            ...
            RectTransformUtility.ScreenPointToLocalPointInRectangle(canvasRT, sp, _canvas.worldCamera, out var lp);
    ...
    {
        if (title) title.text = string.IsNullOrEmpty(info.displayName) ? "生产建筑" : info.displayName;
