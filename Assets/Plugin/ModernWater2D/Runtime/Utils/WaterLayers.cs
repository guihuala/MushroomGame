...
namespace Water2D
{
    ...
    public class WaterLayers
	{
        ...
        /// finds layer index
        /// </summary>
        /// <returns><c>layer index</c>, if layer was found, <c>exception</c> otherwise.</returns>
        /// <param name="layerName">Layer name.</param>
		...
		/// <para>for some reason, this doesn't work on some versions of unity and you have to set your sorting layers by hand</para>
		/// <para>doesn't work on : Unity2021.3.6f1</para>
        /// </summary>
        /// <returns><c>true</c>, if layer was removed, <c>false</c> otherwise.</returns>
        /// <param name="layerName">Layer name.</param>
